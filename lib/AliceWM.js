    ...
    constructor(wininfo) {
        ...
        this.element = (h("div", { class: "aliceWMwin opacity0", style: `
            ...
            (this.resizable && (h("div", { class: "resizers" },
                ...
                "",
            h("div", { class: "title", "on:mousedown": (evt) => {
                    deactivateFrames();
                    this.dragging = true;
                ...
                h("button", { class: "windowButton", "on:click": () => {
                        this.minimizing = true;
                        this.minimize();
                    } },
                    h("img", { src: "/assets/window/minimize.svg", height: "12px", class: "windowButtonIcon" })),
                h("button", { class: "windowButton", "on:click": this.maximize.bind(this) }, (this.maximizeImg = (h("img", { src: "/assets/window/maximize.svg", height: "12px", class: "windowButtonIcon" })))),
                h("button", { class: "windowButton", "on:click": this.close.bind(this) },
