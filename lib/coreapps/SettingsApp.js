...
class SettingsApp extends App {
    ...
    page = async () => (h("div", { style: "height:100%;width:100%;position:absolute", class: `background ${settingsCSS} self` },
        h("div", { class: "header" },
            h("h2", { color: "white" }, "Anura Settings")),
        h("div", { css: this.state, class: "container" },
            h("div", { class: "sidebar" },
                h("div", { class: "sidebar-settings-item" },
                    h("h4", { class: "sidebar-settings-item-name" },
                        h("a", { href: "#general" }, "General"))),
                h("div", { class: "sidebar-settings-item" },
                    h("h4", { class: "sidebar-settings-item-name" },
                        h("a", { href: "#v86" }, "v86"))),
                h("div", { class: "sidebar-settings-item" },
                    h("h4", { class: "sidebar-settings-item-name" },
                        h("a", { href: "#reset" }, "Reset")))),
            h("div", { class: "settings-body" },
                h("div", { id: "general", class: "general settings-category" },
                    ...
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Borderless AboutBrowser"),
                        h("label", { class: "switch" },
                            h("input", { "on:click": (event) => {
                                ...
                                }, id: "borderless-aboutbrowser", type: "checkbox" }),
                            h("span", { class: "slider round" }))),
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Window Edge Clamping"),
                        h("label", { class: "switch" },
                            h("input", { "on:click": (event) => {
                                    if (event.target.checked) {
                                        anura.settings.set("clampWindows", true);
                                    }
                                    else {
                                        anura.settings.set("clampWindows", false);
                                    }
                                }, id: "clampWindows", type: "checkbox" }),
                            h("span", { class: "slider round" }))),
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Transparent Anura Shell Background"),
                        h("label", { class: "switch" },
                            h("input", { "on:click": (event) => {
                                    if (event.target.checked) {
                                        anura.settings.set("transparent-ashell", true);
                                    }
                                    else {
                                        anura.settings.set("transparent-ashell", false);
                                    }
                                }, id: "transparent-ashell", type: "checkbox" }),
                            h("span", { class: "slider round" }))),
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Enable Launcher Keybind"),
                        h("label", { class: "switch" },
                            h("input", { "on:click": (event) => {
                                    if (event.target.checked) {
                                        anura.settings.set("launcher-keybind", true);
                                    }
                                    else {
                                        anura.settings.set("launcher-keybind", false);
                                    }
                                }, id: "launcher-keybind", type: "checkbox" }),
                            h("span", { class: "slider round" }))),
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Custom Wisp URL"),
                        h("input", { class: "settings-item-text-input", "on:change": (event) => {
                                anura.settings.set("wisp-url", event.target.value);
                            }, placeholder: anura.settings.get("wisp-url"), type: "text" })),
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Custom Bare URL (deprecated)"),
                        h("input", { class: "settings-item-text-input", "on:change": (event) => {
                                anura.settings.set("bare-url", event.target.value);
                            }, placeholder: anura.settings.get("bare-url"), type: "text" }))),
                h("div", { id: "v86", class: "v86 settings-category" },
                    h("h3", { class: "settings-category-name" }, "Anura x86"),
                    this.state.show_x86_install ? (h("div", null,
                        h("button", { "on:click": async () => {
                                this.state.x86_installing = true;
                                const chosenRootFS = prompt('Enter the name of the rootfs you want to install ("alpine", "debian", "arch")');
                                if (chosenRootFS == "debian" ||
                                    chosenRootFS == "arch" ||
                                    chosenRootFS == "alpine") {
                                    anura.settings.set("x86-image", chosenRootFS);
                                    await installx86();
                                    ...
                                    alert("Invalid rootfs name! Valid names are: alpine, debian, arch");
                                }
                            }, class: "settings-button" }, "Install x86 Subsystem"),
                        h("div", { id: "tracker" }))) : (h("div", { className: "x86-container" },
                        h("div", { class: "settings-item" },
                            h("h4", { class: "settings-item-name" }, "Custom Bare URL"),
                            h("input", { class: "settings-item-text-input", "on:change": (event) => {
                                    anura.settings.set("relay-url", event.target.value);
                                }, placeholder: anura.settings.get("relay-url"), type: "text" })),
                        h("div", { class: "settings-item" },
                            h("div", { class: "disk-info" },
                                h("h4", { class: "settings-item-name" }, "Disk Size (MB)"),
                                        ...
                                        emulator.add_listener("serial0-output-byte", async (byte) => {
                                            ...
                                            if (char === "\r") {
                                                ...
                                                if (s0data.includes("Finished Disk")) {
                                                    ...
                                                    confirm("Resized disk! Would you like to reload the page?")
                        ...
                        h("div", { class: "settings-button-group" },
                            ...
                            h("button", { "on:click": () => {
                                    if (confirm("Custom RootFSes are in beta and may not work properly. Continue?")) {
                ...
                h("div", { id: "reset", class: "settings-category" },
                    ...
                    h("div", { class: "settings-item" },
                        h("h4", { class: "settings-item-name" }, "Reset your Anura install."),
                        h("button", { class: "settings-button", "on:click": async () => {
                                const confirmation = await confirm("Are you sure you want to powerwash Anura? All of your data will be lost.");
                                if (confirmation) {
