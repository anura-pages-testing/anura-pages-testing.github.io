    ...
    steps = [
            ...
            elm: (h("div", { class: "screen", id: "welcome" },
                ...
                h("div", { id: "gridContent" },
                    h("div", { "on:click": () => {
                        ...
                        h("button", null, "Enable Eruda")),
                    h("img", { id: "animation", src: "assets/oobe/welcome.gif" }),
                    h("div", { id: "bottomButtons" },
                        h("button", { "on:click": () => this.nextStep(), class: "preferredButton" }, "Next"))))),
            on: () => { },
        },
        {
        ...
        },
        {
            elm: (h("div", { class: "screen", id: "downloadingFiles" },
                ...
                h("div", { id: "subtitle" }, "For the best experience, AnuraOS needs to download required assets."),
